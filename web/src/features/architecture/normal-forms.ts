...
export const NORMAL_FORMS: NormalForm[] = [
  ...
  },
  {
    ...
    violation:
      'Storing both client_id and client_address on an invoice. It is the violation the working rule above is really about: change the address and you are updating two rows, and the day you update one is the day they disagree.',
  },
]
