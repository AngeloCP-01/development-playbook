 ...
 * prose string carries markdown link syntax — `[07](07-code-review.md)`, the
 * form `docs/06-testing.md` uses throughout. `InlineCode`
 ...
 * the literal `[07](07-code-review.md)` characters on the page.
 *
