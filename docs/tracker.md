...
`docs/04-project-setup.md` from 323 to 690 lines and **closed TD-28**, which turned out to
...
`--max-warnings 0`, **332 vitest tests across 33 files** in two projects — `unit` (node, data
